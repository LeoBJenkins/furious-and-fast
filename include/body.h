 ...
 */
typedef void (*body_func_t)(body_t *, void *);
 ...
 * @return a pointer to the newly allocated body
 */
body_t *body_init_with_info_and_sprite(list_t *shape, double mass, rgb_color_t color,
 ...
 */
bool body_is_on_screen(body_t *body, 
                       vector_t lower_bounds, 
                       vector_t upper_bounds);
 ...
 *
 * @param b1 a pointer to a body returned from body_init()
 * @param b2 a pointer to a body returned from body_init()
 * @return a bool representing if b1 and b2 are overlapping
 */
bool body_are_overlapping(body_t *b1, body_t *b2);
