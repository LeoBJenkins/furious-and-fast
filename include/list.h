...
/**
 * Removes the first element from the list and returns it, moving
 * all subsequent elements towards the start of the list.
 * 
 * @param list a pointer to a list returned from list_init()
 * @return the element at the beginning of list
 */
 ...
 * 
 * @param list a pointer to a list returned from list_init()
 * @return the element at the end of list
 */
